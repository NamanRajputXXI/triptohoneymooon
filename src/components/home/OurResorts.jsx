...
const OurResorts = () => {
  ...
  return (
    <section className=" mx-6 md:py-20 py-10">
      <div className="mx-auto max-w-7xl   ">
        <div className="max-w-7xl py-10 md:py-20 sm:px-8 items-end justify-between sm:flex sm:pe-6 lg:pe-8">
          <h1 className="text-center   md:text-5xl text-2xl  ">Our Resorts</h1>
