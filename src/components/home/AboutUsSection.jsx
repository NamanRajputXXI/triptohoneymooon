...
const AboutUsSection = () => {
  return (
    <section className="w-full  bg-red-100">
      <div className=" max-w-7xl gap-5 px-5 mx-auto py-20 bg-red-100 px-2 flex md:flex-row flex-col items-center justify-center md:justify-between">
        <div className="flex md:w-1/2 w-full md:px-0 px-5 flex-col gap-5">
        ...
        <div className="md:w-1/2 w-full md:px-0 px-5  items-end justify-center flex gap-5">
          <div className="h-full sm:flex hidden w-full">
            <img
              className="lg:h-64  h-32 w-full rounded-t-full"
