...
import internationalCarouselData from "@/data/internationalCarouselData";
  ...
  return (
    <>
      <section className=" sm:py-20 py-10">
        <div className="mx-auto max-w-[1340px] px-6 sm:px-6     lg:ps-8 ">
          <div className="max-w-7xl sm:px-8 items-end justify-between sm:flex sm:pe-6 lg:pe-8">
            ...
            <div className="mt-8 flex gap-4 lg:mt-0">
              <button
                ...
                className="rounded-full border flex justify-center  items-center bg-gray-600 border-red-[#ED9122] p-3 text-rose-600 transition  hover:text-white"
              >
          ...
          <div className=" sm:mt-16 mt-8 lg:col-span-2 sm:px-8  lg:mx-0">
            <div ref={sliderContainer} className="keen-slider">
              {internationalCarouselData.map((item, i) => (
