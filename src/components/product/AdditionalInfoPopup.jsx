      ...
      <div className="bg-white text-gray-700 flex flex-col gap-5 max-w-5xl h-[500px] overflow-y-auto mx-auto p-6 rounded-lg shadow-xl relative">
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex items-center gap-3">
            ...
            <p>5 nights accommodation in a hotel in Zurich.</p>
          </div>
          <div className="flex items-center gap-3">
            <p className="font-bold">Meals :</p>
            <p>Breakfast from day 2 to day 6</p>
          </div>
          <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <p>It will be provided (Charges are not included)</p>
          </div>
          <div className="flex items-center gap-3">
            <p className="font-bold">Swiss Pass : </p>
            <p>5 Days second class continuous Swiss Pass</p>
          </div>
        </div>
      </div>
    </div>
