...
//   const openGallery = () => {
//     setShowGallery(true);
//     setCurrentImageIndex(5); // Start from the 6th image (index 5)
//   };
...
//           <button
//             onClick={prevImage}
//             className="absolute left-4  top-1/2 transform -translate-y-1/2 text-white text-9xl"
//           >
//             &#8249;
//           </button>
//           <img
...
//           <button
//             onClick={nextImage}
//             className="absolute right-4 top-1/2 transform -translate-y-1/2 text-white text-9xl"
//           >
//             &#8250;
//           </button>
//         </div>
