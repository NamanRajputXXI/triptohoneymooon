      ...
      <div className="max-w-7xl flex flex-col gap-10 mx-auto md:py-20 py-10">
        ...
        <ul className="list-disc ml-5">
          ...
          <li>
            ...
            or Our in this Agreement) refers to Admire Tours & Holidays Pvt.
            Ltd, 34, Sewak park(1st floor), Dwarka more metro, Near metro piller
          ...
          <li>
            <strong>Website</strong> refers to TriptoHoneymoon, accessible from
            <a href="https://triptohoneymoon.com" className="text-blue-500">
        ...
        <section>
          ...
          <h4 className="text-xl font-semibold">Types of Data Collected</h4>
          <h5 className="text-lg font-semibold">Personal Data</h5>
          <p>
        ...
        <section>
          <h5 className="text-lg font-semibold">Usage Data</h5>
        ...
        <h4 className="text-xl font-semibold">Use of Your Personal Data</h4>
        ...
        <h2 className="text-4xl font-semibold">Delete Your Personal Data</h2>
        <p>
        ...
        <p>
          ...
          Company may be required to disclose Your Personal Data if required to
        ...
        <p>
          ...
          of Users of the Service or the public, or protect against legal
          liability.
        </p>
        ...
        <p>By phone number: 18001214252</p>
      </div>
      <Footer />
    </>
  );
